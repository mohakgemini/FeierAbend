...
export const vibes: Vibe[] = [
  ...
  { id: "sonntag1998", title: "Sonntag 1998", cardSubtitle: "Zuhause, ruhig, Radio an", subtitle: "Kaffee warm. Welt ganz leise.", background: image("sonntag1998.jpg"), mobileBackground: image("sonntag1998-mobile.jpg"), playlistId: sommerPlaylistId, tracks: [playlistLoadingTrack] },
];
