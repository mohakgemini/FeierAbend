...
export const vibes: Vibe[] = [
  ...
  { id: "oktoberfest2004", title: "Oktoberfest 2004", cardSubtitle: "Lichter, Freunde, eine letzte Runde", subtitle: "München. Irgendwann im September.", background: image("oktoberfest2004.jpg"), mobileBackground: image("oktoberfest2004-mobile.jpg"), playlistId: defaultPlaylistId, seasonal: "oktoberfest", tracks: [playlistLoadingTrack] },
  { id: "nachtfahrt2001", title: "Nachtfahrt 2001", cardSubtitle: "Autobahn, Lichter, Trance", subtitle: "120 BPM. Kein Ziel nötig.", background: image("nachtfahrt2001.jpg"), mobileBackground: image("nachtfahrt2001-mobile.jpg"), playlistId: defaultPlaylistId, tracks: [playlistLoadingTrack] },
